		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Damage selector",
									"targetURL": "#ui5damageselector-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ui5damageselector-display": {
								"semanticObject": "ui5damageselector",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ui5.damageselector",
									"url": sap.ui.require.toUrl("ui5/damageselector")
								}
							}
						}
					}
